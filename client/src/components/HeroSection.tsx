  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container text-center max-w-4xl mx-auto px-4 pt-10">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/30 bg-white/10 mb-8">
        ...
        <p className="text-lg md:text-xl text-gray-200 mb-5 max-w-2xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-yellow-400/15 border border-yellow-400/40 mb-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-14">
          ...
          <a
            href="#como-funciona"
            className="inline-flex items-center justify-center gap-2 px-8 py-5 border border-white/30 text-white text-lg font-semibold rounded-xl hover:border-primary/80 hover:text-primary transition-all"
          >
            Como Funciona
          </a>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-2xl mx-auto">
          {[
            ...
            <div key={label} className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-white/10 border border-white/15 backdrop-blur-sm">
