...
export default function ProductCard({ product }: { product: Product }) {
  // Monta lista de imagens: deduplica e garante que a imagem principal está na frente
  ...
  return (
    <div className="group relative bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-primary/30 hover:shadow-xl transition-all duration-300 flex flex-col">
      ...
      >
        {/* Imagem única com src swap — sempre visível */}
        <img
          src={currentSrc}
          alt={product.name}
          ...
          onError={(e) => {
            ...
            // Tenta próxima imagem antes do fallback
