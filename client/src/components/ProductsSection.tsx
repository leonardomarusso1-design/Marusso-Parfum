  ...
  return (
    <section id="produtos" className="py-20 bg-background">
      <div className="container">
        ...
        {/* ML Trust banner */}
        <div className="mt-16 rounded-2xl border border-yellow-400/20 bg-yellow-400/5 p-8 text-center">
          <div className="text-4xl mb-3">🛡</div>
          <h3 className="text-xl font-black text-foreground mb-2">
            Compra 100% Protegida pelo <span className="text-yellow-400">Mercado Livre</span>
          </h3>
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm mb-6">
            {["✅ Produto original", "🚚 Frete rápido garantido", "🔄 Troca fácil", "💳 Parcelamento", "🌟 Vendedor verificado"].map(item => (
              <span key={item} className="text-foreground font-medium">{item}</span>
            ))}
          </div>
          <a
            href="#produtos"
            className="inline-flex items-center gap-2 px-8 py-4 bg-yellow-400 text-black font-black rounded-xl hover:bg-yellow-300 transition-all text-base"
          >
